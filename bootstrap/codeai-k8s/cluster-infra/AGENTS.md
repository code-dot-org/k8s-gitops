...
If you are trying to update [`infra/external-dns/external-dns.tf`](./infra/external-dns/external-dns.tf) to look like newer addon versions, read [`deriving-from-addons.md`](./deriving-from-addons.md) first.
