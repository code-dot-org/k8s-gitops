...
The runner lives in
[`k8s-gitops/bootstrap/codeai-k8s/cluster-infra-argocd/test/argo-trace-stress-test/`](https://github.com/code-dot-org/k8s-gitops/tree/main/bootstrap/codeai-k8s/cluster-infra-argocd/test/argo-trace-stress-test).
